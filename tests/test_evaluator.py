...
class EvaluatorTests(unittest.TestCase):
    ...
    def test_estimated_distance(self):
        ...
        result = evaluate(classes, meetings)
        self.assertEqual(result.soft["distancia"], 1)
    ...
    def test_lab_building_distance(self):
        metadata = room_metadata("L307")
        self.assertTrue(metadata["laboratorio"])
        self.assertEqual(metadata["predio"], "laboratorio")
        self.assertEqual(estimated_room_distance("308", "L307"), 3)
